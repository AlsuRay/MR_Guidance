...
namespace Assets.Scripts
{
    ...
    public static class Parameters
    {
        ...
        internal const int LayersHigh = 16;
        internal const int LayersLow = 10;
        ...
        internal const float MinTimesSeen = 3;
        internal const float ObjectTimeOut = 4f;
        internal const float MaxIdenticalObject = 0.5f;
    }
